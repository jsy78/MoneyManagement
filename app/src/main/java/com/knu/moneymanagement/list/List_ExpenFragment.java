...
public class List_ExpenFragment extends Fragment implements Constant {
    ...
    public List_ExpenFragment() {
    }

    @Override
    public void onAttach(@NonNull Context context) {
        Log.d("MyTag", "List_ExpenFragment onAttach");
        super.onAttach(context);
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        Log.d("MyTag", "List_ExpenFragment onCreate");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("MyTag", "List_ExpenFragment onCreateView");
        // Inflate the layout for this fragment
        if(getActivity() != null) {
            View root = inflater.inflate(R.layout.fragment_list_expen, container, false);

            constraintLayout = root.findViewById(R.id.listExpenView);
            notExistText = root.findViewById(R.id.expenRecyclerNotExist);
            mRecyclerView = root.findViewById(R.id.expenRecyclerView);
...
//            });
    ...
    @Override
    public void onStart() {
        Log.d("MyTag", "List_ExpenFragment onStart");
        super.onStart();
    }

    @Override
    public void onResume() {
        Log.d("MyTag", "List_ExpenFragment onResume");
        super.onResume();
        constraintLayout.setVisibility(View.VISIBLE);
        createExpenList(StaticVariable.year, StaticVariable.month, StaticVariable.sort);
    ...
    @Override
    public void onPause() {
        Log.d("MyTag", "List_ExpenFragment onPause");
        super.onPause();
    }

    @Override
    public void onStop() {
        Log.d("MyTag", "List_ExpenFragment onStop");
        super.onStop();
    }

    @Override
    public void onDestroyView() {
        Log.d("MyTag", "List_ExpenFragment onDestroyView");
        super.onDestroyView();
    }

    @Override
    public void onDestroy() {
        Log.d("MyTag", "List_ExpenFragment onDestroy");
        super.onDestroy();
    }

    @Override
    public void onDetach() {
        Log.d("MyTag", "List_ExpenFragment onDetach");
        super.onDetach();
    }

    public void createExpenList(int yearValue, int monthValue, int sort){
        Log.d("MyTag", "List_ExpenFragment createExpenList");
        MoneyDBHelper dbHelper = new MoneyDBHelper(getActivity());
        ...
        switch (sort) {
            case DESC_DAY:
                sqlSelect = MoneyDBCtrct.SQL_SELECT + " WHERE " + MoneyDBCtrct.COL_CATEGORY + "=" + "'지출'" + " AND " + MoneyDBCtrct.COL_YEAR + "=" + yearValue + " AND " + MoneyDBCtrct.COL_MONTH + "=" + monthValue + " ORDER BY " + MoneyDBCtrct.COL_DAY + " DESC";
                break;
            case ASC_MONEY:
                sqlSelect = MoneyDBCtrct.SQL_SELECT + " WHERE " + MoneyDBCtrct.COL_CATEGORY + "=" + "'지출'" + " AND " + MoneyDBCtrct.COL_YEAR + "=" + yearValue + " AND " + MoneyDBCtrct.COL_MONTH + "=" + monthValue + " ORDER BY " + MoneyDBCtrct.COL_MONEY + " ASC";
                break;
            case DESC_MONEY:
                sqlSelect = MoneyDBCtrct.SQL_SELECT + " WHERE " + MoneyDBCtrct.COL_CATEGORY + "=" + "'지출'" + " AND " + MoneyDBCtrct.COL_YEAR + "=" + yearValue + " AND " + MoneyDBCtrct.COL_MONTH + "=" + monthValue + " ORDER BY " + MoneyDBCtrct.COL_MONEY + " DESC";
                break;
            case ASC_DAY:
            default:
                sqlSelect = MoneyDBCtrct.SQL_SELECT + " WHERE " + MoneyDBCtrct.COL_CATEGORY + "=" + "'지출'" + " AND " + MoneyDBCtrct.COL_YEAR + "=" + yearValue + " AND " + MoneyDBCtrct.COL_MONTH + "=" + monthValue + " ORDER BY " + MoneyDBCtrct.COL_DAY + " ASC";
        }
        ...
        if(mAdapter.getItemCount() == 0) {
            Toast.makeText(getActivity(), "지출 내역이 없습니다.", Toast.LENGTH_SHORT).show();
