...
public class Graph_AccumulateFragment extends Fragment {

    private LineChart lineChart;

    public Graph_AccumulateFragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_graph_accumulate, container, false);
    ...
    public void createLine(int year) {
        ...
        income.add(new Entry(0, monthIncome[0]));
        for (int i = 1; i < 12; i++) {
            monthIncome[i] += monthIncome[i - 1];
        ...
        expen.add(new Entry(0, monthExpen[0]));
        for (int i = 1; i < 12; i++) {
            monthExpen[i] += monthExpen[i - 1];
